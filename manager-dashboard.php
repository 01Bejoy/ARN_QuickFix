...
// ====================================================================
// ====================================================================
// LIVE OVERDUE MAINTENANCE SYNCHRONIZER
// ====================================================================
// Keep the database status itself synchronized with the due date so the
// dashboard, manager schedule page and client portal all use one source.
...
$qOverdue = $conn->query("SELECT COUNT(*) AS total
...
<a href="logout.php" class="btn btn-sm btn-outline-danger rounded-pill px-3 py-1 fw-bold" onclick="return confirm('Are you sure you want to log out?');" style="font-size:12px;">Logout</a>
  ...
  <div class="container py-5" style="max-width: 1140px;">
    ...
    <div class="row g-4 mt-1">
      <div class="col-md-4">
        <a href="manager-assets.php" class="d-flex flex-column p-4 bg-white border rounded-4 text-decoration-none h-100 transition-panel" style="border-color:#E2E8F0;color:inherit;">
          <div class="d-flex justify-content-between align-items-center mb-3"><div style="font-size:26px;">🏷️</div><span class="badge bg-primary-subtle text-primary">Registry</span></div>
          <h4 class="fw-bold mb-2 text-dark" style="font-size:20px;">Asset Management</h4>
          <p class="text-secondary small m-0">Search every registered Asset ID, customer, asset type and service history.</p>
        </a>
      </div>
      <div class="col-md-4">
        <a href="manager-technicians.php" class="d-flex flex-column p-4 bg-white border rounded-4 text-decoration-none h-100 transition-panel" style="border-color:#E2E8F0;color:inherit;">
          <div class="d-flex justify-content-between align-items-center mb-3"><div style="font-size:26px;">👨‍🔧</div><span class="badge bg-info-subtle text-info">Performance</span></div>
          <h4 class="fw-bold mb-2 text-dark" style="font-size:20px;">Technician Management</h4>
          <p class="text-secondary small m-0">View every technician, assigned/completed jobs, average ratings, customer reviews and promotion history.</p>
        </a>
      </div>
      <div class="col-md-4">
        <a href="manager-price-history.php" class="d-flex flex-column p-4 bg-white border rounded-4 text-decoration-none h-100 transition-panel" style="border-color:#E2E8F0;color:inherit;">
          <div class="d-flex justify-content-between align-items-center mb-3"><div style="font-size:26px;">৳</div><span class="badge bg-warning-subtle text-warning">Audit</span></div>
          <h4 class="fw-bold mb-2 text-dark" style="font-size:20px;">Service Price History</h4>
          <p class="text-secondary small m-0">Update service prices while preserving original values, previous prices, manager identity, date and reason.</p>
        </a>
      </div>
    </div>
